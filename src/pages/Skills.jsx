...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Java", "Python", "C++", "C"] },
    { title: "Frameworks", items: ["Spring Boot", "React", "Node.js", "Express.js"] },
    { title: "Databases", items: ["MySQL", "MongoDB"] },
    { title: "Tools & Technologies", items: ["Git", "Power BI", "Postman", "Eclipse", "VS Code"] },
  ],
  [
    {
    ...
    },
    {
      ...
      items: ["Linux", "Windows", "Problem Solving", "Data Analysis", "Full Stack Development"],
    },
  ],
];
...
export default function Skills() {
  ...
  return (
    <section className="skills-container" id="skills">
      ...
      >
        <h2 className="text-5xl text-cyan-400 font-semibold mb-3">Technical Skills</h2>
        <div className="w-28 h-[2px] bg-cyan-400 mx-auto mb-6"></div>
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ⚡ Full Stack Development expertise with strong foundation in Java, Python, and modern web technologies.
        </p>
      </motion.div>
