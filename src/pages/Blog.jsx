...
export default function Blog() {
  const defaultPosts = [
    {
      id: 1,
      title: "Adventures in Travel & Tech 🌍✈️",
      text: "Traveling opens my mind to new perspectives, just like exploring new technologies. Whether it's discovering a hidden gem in a new city or uncovering an innovative framework, both journeys fuel my curiosity and creativity.",
    },
    {
      id: 2,
      title: "Exploring Emerging Technologies 🚀",
      text: "From AI and machine learning to blockchain and quantum computing, I'm constantly diving into cutting-edge technologies. Each new tech stack is like learning a new language that opens doors to solving problems I never thought possible.",
    },
    {
      id: 3,
